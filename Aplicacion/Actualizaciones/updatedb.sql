...
521;
UPDATE `config` SET `config_valor`='2014-01-01' WHERE `config_nombre`='ULTIMAEXPORTACION';
522;
UPDATE `config` SET `config_valor`='2014-01-01' WHERE `config_nombre`='ULTIMAIMPORTACION';
523;
