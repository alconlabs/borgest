object Princ: TPrinc
  ...
  object MenuPrincipal: TAdvToolBarPager
    ...
    Width = 1362
    Height = 100
    ActivePage = AdvPageContabilidad
    ...
    object AdvPageContabilidad: TAdvPage
      Left = 4
      Top = 26
      Width = 1354
      Height = 69
      Caption = 'Contabilidad'
      object AdvToolBarLibrosIvas: TAdvToolBar
        Left = 3
        Top = 3
        Width = 106
        Height = 63
        ...
        ToolBarStyler = AdvToolBarOfficeStyler1
        ParentOptionPicture = True
        object btnestadoiva: TAdvGlowButton
          Left = 2
          Top = 2
          Width = 100
          Height = 41
