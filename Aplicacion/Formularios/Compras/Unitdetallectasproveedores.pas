unit Unitdetallectasproveedores;
...
type
  Tdetallectasproveedores = class(TForm)
    ZQuery2: TZQuery;
...
var
  detallectasproveedores: Tdetallectasproveedores;
...
function Tdetallectasproveedores.GenerarWhere:string;
var
  where:string;
begin
...
procedure Tdetallectasproveedores.SetNotRequired;
var
  i:integer;
begin
...
procedure Tdetallectasproveedores.FormClose(Sender: TObject; var Action: TCloseAction);
begin
...
procedure Tdetallectasproveedores.FormCreate(Sender: TObject);
begin
...
procedure Tdetallectasproveedores.FormKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
    Princ.OnKeyDown(sender, Key, Shift);
end;

procedure Tdetallectasproveedores.FormShow(Sender: TObject);
begin
    princ.Permisos1.guardarlog(self.ClassName+'.Show');
end;

procedure Tdetallectasproveedores.cargatemporal;
var
  id:string;
begin
...
procedure Tdetallectasproveedores.DBGrid1DblClick(Sender: TObject);
begin
...
procedure Tdetallectasproveedores.btnactualizarClick(Sender: TObject);
var
  acumulado:real;
...
procedure Tdetallectasproveedores.BtnDetalleImputacionClick(Sender: TObject);
var
  orden:integer;
begin
    if temporal_idproceso<>'' then
...
procedure Tdetallectasproveedores.btnimprimirClick(Sender: TObject);
var
  grupo, condicion_saldoanterior:string;
begin
