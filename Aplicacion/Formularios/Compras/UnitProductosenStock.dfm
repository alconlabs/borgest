object ProductosenStock: TProductosenStock
  Left = 0
  Top = 0
  ...
  object panelgrilla: TAdvPanel
    ...
    object DBGrid1: TDBGrid
      ...
      Columns = <
        ...
        item
          Expanded = False
          FieldName = 'movimdepodetallecantidadenviar'
  ...
  object ZQGrilla: TZQuery
    ...
    CachedUpdates = True
    BeforePost = ZQGrillaBeforePost
    SQL.Strings = (
      'select *, 0.00 as movimdepodetallecantidadenviar from productos'
      'inner join rubros on productos.rubro_id=rubros.rubro_id'
        ...
        'inner join productodeposito productodeposito2 on productos.produ' +
        'cto_id=productodeposito2.producto_id'
      'where productodeposito.producdepo_stockactual>0'
    ...
    object ZQGrillamovimdepodetallecantidadenviar: TFloatField
      FieldName = 'movimdepodetallecantidadenviar'
      DisplayFormat = '0'
      EditFormat = '0'
    end
