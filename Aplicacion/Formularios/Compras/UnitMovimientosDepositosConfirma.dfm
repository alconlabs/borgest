inherited MovimientosDepositosConfirma: TMovimientosDepositosConfirma
  Caption = 'Movimiento entre depositos - Confirmar Recepcion'
  ClientHeight = 415
  ClientWidth = 848
  ExplicitWidth = 864
  ExplicitHeight = 453
  ...
  object ZQmovimdepodetalles: TZQuery
    ...
    SQL.Strings = (
        ...
        'select *, movimdepodetalle_cantidadenviar as recibido from movim' +
        'depodetalles'
    ...
    object ZQmovimdepodetallesmarca_id: TIntegerField
      FieldName = 'marca_id'
    end
    object ZQmovimdepodetallesseccion_id: TIntegerField
      FieldName = 'seccion_id'
    end
    object ZQmovimdepodetallesrecibido: TFloatField
      FieldName = 'recibido'
    end
  end
