...
type
  TComisionesBorradorPendientes = class(TForm)
    ...
    ZQDocumentosVentasPendientescliente_id_1: TIntegerField;
    ZQDocumentosVentasPendientescliente_nombre: TStringField;
    ZQDocumentosVentasPendientescliente_domicilio: TStringField;
    ZQDocumentosVentasPendientescliente_documentonro: TStringField;
    ZQDocumentosVentasPendientescliente_documentotipo: TStringField;
    ZQDocumentosVentasPendientescliente_telefono: TStringField;
    ZQDocumentosVentasPendientescliente_celular: TStringField;
    ZQDocumentosVentasPendientescliente_mail: TStringField;
    ZQDocumentosVentasPendientescondicioniva_id: TIntegerField;
    ZQDocumentosVentasPendientescliente_listaprecio: TIntegerField;
    ZQDocumentosVentasPendientescliente_condicionventa: TStringField;
    ZQDocumentosVentasPendienteslocalidad_id: TIntegerField;
    ZQDocumentosVentasPendientescliente_observaciones: TStringField;
    ZQDocumentosVentasPendientespersonal_id_2: TIntegerField;
    ZQDocumentosVentasPendientescliente_diasvenc: TIntegerField;
...
begin
    ...
    ZQDocumentosVentasPendientes.SQL.Add('inner join clientes on documentosventas.cliente_id=clientes.cliente_id ');
