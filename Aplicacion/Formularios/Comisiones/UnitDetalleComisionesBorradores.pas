unit UnitDetalleComisionesBorradores;
...
type
  TDetalleComisionesBorradores = class(TABMbase)
    Label4: TLabel;
...
var
  DetalleComisionesBorradores: TDetalleComisionesBorradores;
...
procedure TDetalleComisionesBorradores.btnguardarClick(Sender: TObject);
var
  acumulado:real;
begin
  inherited;
...
procedure TDetalleComisionesBorradores.btnimprimirClick(Sender: TObject);
begin
  inherited;
...
procedure TDetalleComisionesBorradores.DBGrid1DblClick(Sender: TObject);
begin
  inherited;
...
procedure TDetalleComisionesBorradores.FormClose(Sender: TObject;
...
procedure TDetalleComisionesBorradores.FormShow(Sender: TObject);
begin
  inherited;
