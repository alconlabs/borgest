unit UnitListaNotasCreditodeVentas;
...
type
  TListaNotasCreditodeVentas = class(Tlistabase)
...
var
  ListaNotasCreditodeVentas: TListaNotasCreditodeVentas;
...
procedure TListaNotasCreditodeVentas.btneliminarClick(Sender: TObject);
begin
  inherited;
...
procedure TListaNotasCreditodeVentas.btnfiltrarClick(Sender: TObject);
begin
  inherited;
...
procedure TListaNotasCreditodeVentas.btnmodificarClick(Sender: TObject);
begin
  inherited;
    if ZQGrilla.Active then
      begin
...
procedure TListaNotasCreditodeVentas.btnnuevoClick(Sender: TObject);
begin
  inherited;
