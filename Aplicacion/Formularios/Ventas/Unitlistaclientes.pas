...
procedure Tlistaclientes.eliminar;
begin
//    ZQuery2.SQL.Clear;
...
procedure Tlistaclientes.FormCreate(Sender: TObject);
begin
    abm:=0;
//    Panelabm.Visible:=false;
end;

procedure Tlistaclientes.modificar;
begin
...
procedure Tlistaclientes.agregar;
begin
...
function Tlistaclientes.control:boolean;
var
  error:integer;
begin
    error:=0;
...
procedure Tlistaclientes.btnelimiClick(Sender: TObject);
begin
...
procedure Tlistaclientes.btnmodiClick(Sender: TObject);
begin
     if ZQGrilla.active then
      begin
...
procedure Tlistaclientes.btncrearClick(Sender: TObject);
begin
    try
      clientes:=Tclientes.Create(self);
    finally
...
procedure Tlistaclientes.Button5Click(Sender: TObject);
begin
