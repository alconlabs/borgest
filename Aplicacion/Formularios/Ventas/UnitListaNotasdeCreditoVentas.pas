unit UnitListaNotasdeCreditoVentas;
...
type
  TListaNotasdeCreditoVentas = class(Tlistabase)
...
var
  ListaNotasdeCreditoVentas: TListaNotasdeCreditoVentas;
...
procedure TListaNotasdeCreditoVentas.btneliminarClick(Sender: TObject);
begin
  inherited;
...
procedure TListaNotasdeCreditoVentas.btnfiltrarClick(Sender: TObject);
begin
  inherited;
...
procedure TListaNotasdeCreditoVentas.btnmodificarClick(Sender: TObject);
begin
  inherited;
    if ZQGrilla.Active then
      begin
...
procedure TListaNotasdeCreditoVentas.btnnuevoClick(Sender: TObject);
begin
  inherited;
