...
type
  Ttipodocumento = class(TABMbase)
    ...
    Label15: TLabel;
    tipodocu_tipoctacte: TGTBComboBox;
...
begin
    ...
    ZQExecSQL.sql.add('puntoventa_id, tipodocu_letra, tipodocu_debcred, ');
    ZQExecSQL.sql.add('tipodocu_preimpresos, tipodocu_impresora, tipodocu_copias, tipodocu_preview, ');
    ZQExecSQL.sql.add('tipodocu_prompt, tipodocu_tipoctacte, tipodocu_archivoimpresion, tipodocu_leyenda, tipodocu_manual) ');
    ...
    ZQExecSQL.parambyname('tipodocu_tipoctacte').asstring:=tipodocu_tipoctacte.text;
...
begin
    ...
    ZQExecSQL.sql.add('tipodocu_tipoctacte=:tipodocu_tipoctacte, ');
...
begin
  inherited;
    ...
    tipodocu_tipoctacte.Buscar(ZQSelect.FieldByName('tipodocu_tipoctacte').AsString);
