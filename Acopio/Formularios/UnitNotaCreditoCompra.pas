...
type
  TNotaCreditoCompra = class(TDocumentoBase)
...
var
  NotaCreditoCompra: TNotaCreditoCompra;
...
procedure TNotaCreditoCompra.GuardarEnDataset;
begin
    inherited;
...
procedure TNotaCreditoCompra.calculartotal(posicion:integer);
begin
    if posicion<1 then
...
procedure TNotaCreditoCompra.documento_neto21Exit(Sender: TObject);
begin
  inherited;
    calculartotal((Sender as twincontrol).TabOrder);
end;

procedure TNotaCreditoCompra.FormCreate(Sender: TObject);
begin
  inherited;
    documento_puntoventa.Text:='0';
end;

procedure TNotaCreditoCompra.btnguardarClick(Sender: TObject);
begin
    calculartotales;
