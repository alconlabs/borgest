unit UnitlistaNotasCreditoCompras;
...
type
  TListaNotasCreditoCompra = class(Tlistabase)
...
var
  ListaNotasCreditoCompra: TListaNotasCreditoCompra;
...
procedure TListaNotasCreditoCompra.btnanularClick(Sender: TObject);
begin
  inherited;
    if ZQGrilla.RecordCount>0 then
      Princ.AbrirDocumento(ZQGrilla.FieldByName(campo_id).AsString,TIPODOCU_NOTACREDITOCOMPRA,ABM_ANULAR);
end;

procedure TListaNotasCreditoCompra.btneliminarClick(Sender: TObject);
begin
  inherited;
    if ZQGrilla.RecordCount>0 then
      Princ.AbrirDocumento(ZQGrilla.FieldByName(campo_id).AsString,TIPODOCU_NOTACREDITOCOMPRA,ABM_ELIMINAR);
end;

procedure TListaNotasCreditoCompra.btnfiltrarClick(Sender: TObject);
begin
  inherited;
...
procedure TListaNotasCreditoCompra.btnmodificarClick(Sender: TObject);
begin
  inherited;
    if ZQGrilla.RecordCount>0 then
      Princ.AbrirDocumento(ZQGrilla.FieldByName(campo_id).AsString,TIPODOCU_NOTACREDITOCOMPRA,ABM_MODIFICAR);
end;

procedure TListaNotasCreditoCompra.btnnuevoClick(Sender: TObject);
begin
  inherited;
    Princ.AbrirDocumento('',TIPODOCU_NOTACREDITOCOMPRA,ABM_AGREGAR);
end;
