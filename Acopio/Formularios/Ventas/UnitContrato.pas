...
procedure Tcontrato.puntoventa_idSelect(Sender: TObject);
begin
  inherited;
...
procedure Tcontrato.sucursal_idSelect(Sender: TObject);
begin
  inherited;
...
procedure Tcontrato.tipodocu_idSelect(Sender: TObject);
begin
  inherited;
    documento_numero.Text:='';
    if tipodocu_id.ItemIndex>-1 then
...
procedure Tcontrato.imprimir;
begin

end;

procedure Tcontrato.ZQSelectAfterOpen(DataSet: TDataSet);
begin
  inherited;
...
procedure Tcontrato.FormCreate(Sender: TObject);
begin
  inherited;
    id:='';
...
procedure Tcontrato.FormShow(Sender: TObject);
begin
  inherited;
    if abm=1 then
      id:='';
...
procedure Tcontrato.anular;
begin

end;

function Tcontrato.control:boolean;
var
  error:integer;
begin
    error:=0;
...
procedure Tcontrato.btnguardarClick(Sender: TObject);
begin
  inherited;
       case abm of
        1:begin
