...
type
  Tlistarecibosventa = class(TForm)
...
var
  listarecibosventa: Tlistarecibosventa;

implementation

uses UnitPrinc, Unitrecibosventa;

{$R *.dfm}

procedure Tlistarecibosventa.eliminar;
begin
//    ZQuery2.SQL.Clear;
...
procedure Tlistarecibosventa.FormCreate(Sender: TObject);
begin
    abm:=0;
//    Panelabm.Visible:=false;
end;

procedure Tlistarecibosventa.modificar;
begin
...
procedure Tlistarecibosventa.agregar;
begin
...
function Tlistarecibosventa.control:boolean;
var
  error:integer;
begin
    error:=0;
...
procedure Tlistarecibosventa.Button2Click(Sender: TObject);
begin
    if ZQGrilla.Active then
      begin
          if ZQGrilla.RecordCount>0 then
            begin
                Princ.AbrirDocumentoVenta(ZQGrilla.FieldByName('documentoventa_id').AsString,'Recibo de Venta',3);
            end;
      end;
end;

procedure Tlistarecibosventa.Button3Click(Sender: TObject);
begin
    if ZQGrilla.Active then
      begin
          if ZQGrilla.RecordCount>0 then
            begin
                Princ.AbrirDocumentoVenta(ZQGrilla.FieldByName('documentoventa_id').AsString,'Recibo de Venta',2);
            end;
      end;
end;

procedure Tlistarecibosventa.Button4Click(Sender: TObject);
begin
    Princ.AbrirDocumentoVenta('','Recibo de Venta',1);

end;

procedure Tlistarecibosventa.Button5Click(Sender: TObject);
begin
    ...
    ZQGrilla.SQL.Text:='select * from documentosventas '+
                       ...
                       ' where tipodocu_nombre="Recibo de Venta" '+princ.empresa_where;
