...
type
  Tlistacontratos = class(Tlistabase)
...
var
  listacontratos: Tlistacontratos;

implementation

uses UnitDocumentoBase, UnitPrinc, UnitContrato;

{$R *.dfm}

procedure Tlistacontratos.btnfiltrarClick(Sender: TObject);
begin
  inherited;
    ...
    ZQGrilla.SQL.Text:='select * from documentos '+
                       ...
                       ' where tipodocu_nombre="Contrato de Compra" '+Princ.empresa_where;
...
procedure Tlistacontratos.btnmodificarClick(Sender: TObject);
begin
  inherited;
          ...
          if ZQGrilla.RecordCount>0 then
            begin
                try
                  ...
                  Contrato.abm:=2;
                  Contrato.tipodocu_nombre:='Contrato de Compra';
                  contrato.id:=self.id;
                  Contrato.btnguardar.Caption:='Guardar';
                  Contrato.Show;
                end;
            end;
      end;
...
procedure Tlistacontratos.btnnuevoClick(Sender: TObject);
begin
  inherited;
    try
      Contrato:=TContrato.Create(self);
