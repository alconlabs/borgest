...
type
  TNotaCreditoVenta = class(TDocumentoBase)
...
procedure TNotaCreditoVenta.calculartotal(posicion:integer);
begin
    if posicion<1 then
...
procedure TNotaCreditoVenta.documento_neto21Exit(Sender: TObject);
begin
  inherited;
