object DocumentosDineroPendientes: TDocumentosDineroPendientes
  Left = 0
  Top = 0
  ...
  object ZQDocumentosPendientes: TZQuery
    ...
    object ZQDocumentosPendientesentidaddadorcarga_id: TIntegerField
      FieldName = 'entidaddadorcarga_id'
    end
    object ZQDocumentosPendientesdocumento_chofer: TStringField
      FieldName = 'documento_chofer'
      Size = 100
    end
    object ZQDocumentosPendientesdocumento_chofercuit: TStringField
      FieldName = 'documento_chofercuit'
      Size = 45
    end
    object ZQDocumentosPendientesdocumento_transpchasis: TStringField
      FieldName = 'documento_transpchasis'
      Size = 45
    end
    object ZQDocumentosPendientesdocumento_transpacoplado: TStringField
      FieldName = 'documento_transpacoplado'
      Size = 45
    end
    object ZQDocumentosPendientesdocumento_transptarifaflete: TFloatField
      FieldName = 'documento_transptarifaflete'
    end
    object ZQDocumentosPendientesdocumento_transpanticipo: TFloatField
      FieldName = 'documento_transpanticipo'
    end
    object ZQDocumentosPendientesdocumento_cartaportetarifaflete: TFloatField
      FieldName = 'documento_cartaportetarifaflete'
    end
    object ZQDocumentosPendientesdocumento_nogravado: TFloatField
