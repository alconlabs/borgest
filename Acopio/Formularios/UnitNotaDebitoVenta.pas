...
type
  TNotaDebitoVenta = class(TDocumentoBase)
...
procedure TNotaDebitoVenta.calculartotal(posicion:integer);
begin
    if posicion<1 then
...
procedure TNotaDebitoVenta.documento_neto21Exit(Sender: TObject);
begin
  inherited;
