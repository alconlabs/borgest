...
CREATE  TABLE IF NOT EXISTS `dbborgest`.`tiposdocumento` (
  ...
  `tipodocu_leyenda` VARCHAR(200) NULL ,
...
CREATE  TABLE IF NOT EXISTS `dbborgest`.`condicioniva` (
  ...
  `condicioniva_idfiscal` INT NULL DEFAULT 0 ,
...
CREATE  TABLE IF NOT EXISTS `dbborgest`.`documentosventas` (
  ...
  `documentoventa_nrodetallepago` VARCHAR(45) NULL ,
  `documentoventa_solicitudcliente` VARCHAR(255) NULL ,
  `documentoventa_trabajorealizado` VARCHAR(255) NULL ,
...
CREATE  TABLE IF NOT EXISTS `dbborgest`.`productos` (
  ...
  `producto_imprimir` INT(3) NULL DEFAULT 0 ,
...
CREATE  TABLE IF NOT EXISTS `dbborgest`.`menuperfil` (
  `menuperfil_id` INT NOT NULL AUTO_INCREMENT ,
...
-- -----------------------------------------------------
-- Table `dbborgest`.`documentoscompras`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `dbborgest`.`documentoscompras` (
  `documentocompra_id` INT NOT NULL ,
  `documentocompra_numero` INT NULL ,
  `documentocompra_fecha` DATE NULL ,
  `documentocompra_hora` TIME NULL ,
  `documentocompra_total` FLOAT(20,4) NULL ,
  `documentocompra_estado` VARCHAR(45) NULL ,
  `documentocompra_pagado` FLOAT(20,4) NULL ,
  `documentocompra_saldo` FLOAT(20,4) NULL ,
  `documentocompra_observacion` VARCHAR(255) NULL ,
  `documentocompra_condicionventa` INT(3) NULL ,
  `documentocompra_fechavenc` DATE NULL ,
  `personal_id` INT NOT NULL ,
  `proveedor_id` INT NOT NULL ,
  `tipodocu_id` INT NOT NULL ,
  `documentocompra_neto21` FLOAT(20,4) NULL ,
  `documentocompra_iva21` FLOAT(20,4) NULL ,
  `documentocompra_neto105` FLOAT(20,4) NULL ,
  `documentocompra_iva105` FLOAT(20,4) NULL ,
  `documentocompra_otrosimpuestos` FLOAT(20,4) NULL ,
  `documentocompra_puntoventa` INT(3) NULL ,
...
-- -----------------------------------------------------
-- Table `dbborgest`.`documentocompradetalles`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `dbborgest`.`documentocompradetalles` (
  `documentocompradetalle_id` INT NOT NULL ,
  `documentocompradetalle_descripcion` VARCHAR(150) NULL ,
  `documentocompradetalle_cantidad` FLOAT(20,4) NULL ,
  `documentocompradetalle_precio` FLOAT(20,4) NULL ,
  `documentocompradetalle_total` FLOAT(20,4) NULL ,
  `documentocompradetalle_estado` VARCHAR(45) NULL ,
  `documentocompradetalle_observacion` VARCHAR(255) NULL ,
  `documentocompradetalle_idorig` INT NULL ,
  `documentocompradetalle_cantidadpendiente` FLOAT(20,4) NULL ,
  `producto_id` INT NOT NULL ,
  `documentocompra_id` INT NOT NULL ,
...
-- -----------------------------------------------------
-- Table `dbborgest`.`clientevehiculo`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `dbborgest`.`clientevehiculo` (
  `clientevehiculo_id` INT NOT NULL ,
  `clientevehiculo_fechaventa` DATE NULL ,
  `clientevehiculo_modelo` VARCHAR(45) NULL ,
  `clientevehiculo_marca` VARCHAR(45) NULL ,
  `clientevehiculo_nrochasis` VARCHAR(45) NULL ,
  `clientevehiculo_nromotor` VARCHAR(45) NULL ,
  `cliente_id` INT NOT NULL ,
  `clientevehiculo_observaciones` VARCHAR(255) NULL ,
